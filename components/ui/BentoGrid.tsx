...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('csebyoung@gmail.com');
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(103,32,210,1) 38%, rgba(213,45,94,1) 100%)',
      }}
    >
